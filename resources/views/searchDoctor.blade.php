...
@section('title',  'Doctor Search List | ' . $setting->title)
@section('meta-title',  'Doctor Search List | ' . $setting->title)
...
@section('og-title', 'Doctor Search List | ' . $setting->title)
...
@section('twitter-title',  'Doctor Search List | ' . $setting->title)
...
<section style="background-image: url('public/front/images/coverimage1.jpg'); width: 100%; height: 260px;" data-stellar-background-ratio="0.5">
    <div class="container">
      <div class="row justify-content-center pb-3">
        ...
        <h2 style="line-height: 260px;">Search Result for <span class="text-success">{{ count($doctors) }}</span> Doctors</h2>
        </div>
      </div>
    </div>
  </section>
