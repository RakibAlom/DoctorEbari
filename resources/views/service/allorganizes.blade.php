...
@section('title',  'Organization | ' . $setting->title)
@section('meta-title',  'Organization | ' . $setting->title)
...
@section('og-title', 'Organization | ' . $setting->title)
...
@section('twitter-title',  'Organization | ' . $setting->title)
        ...
        <div class="container">
            <div class="row justify-content-center pb-3">
                <div class="col-md-8 text-center heading-section ftco-animate">
                    <h2 class="mb-4" style="line-height: 260px">Our <span class="text-success">Social Organizes</span></h2>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text text-center">
                            ...
                            <div class="faded">
                                <p style="min-height: 60px;">{!! $organize->address !!}</p>
